...
import com.ufund.api.ufundapi.controller.DonationRewardController;
...
@Tag("Controller-tier")
public class DonationRewardControllerTest {
    private DonationRewardController DataController;
    private DataFileDAO<DonationReward> mockDataDAO;
    ...
    public void setupDataController() {
        ...
        mockDataDAO = mock(DonationRewardFileDAO.class);//Use of mock will fill in constructor dependencies.
        DataController = new DonationRewardController(mockDataDAO);
    }
    /**
    ...
    */
    ...
    public void testGet() throws IOException {  // getData may throw IOException
        ...
        ResponseEntity<DonationReward> response = DataController.getData(Data.getName());
    ...
    */
    ...
    public void testCreateData() throws IOException {  // createData may throw IOException
        ...
        ResponseEntity<DonationReward> response = DataController.createData(Data);
    ...
    */
    ...
    public void testGetCupboard() throws IOException { // getCupboard may throw IOException
        ...
        ResponseEntity<DonationReward[]> response = DataController.getDataArray();
    ...
    */
    ...
    public void testSearchDatas() throws IOException { // searchDatas may throw IOException
        ...
        ResponseEntity<DonationReward[]> response = DataController.searchDataArray(searchString);
    ...
    */
    ...
    public void testDeleteData() throws IOException {
        ...
        ResponseEntity<DonationReward> response = DataController.deleteData(DataId);
